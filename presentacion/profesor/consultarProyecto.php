...
<div class="container">
    ...
    foreach ($proyectos as $p) {
		...
		echo "<td>" . 
		"<a href='modalAsignar.php?idE=" . $p->getId() . "&tipo=tutor' data-toggle='modal' data-target='#modalAsignar' ><span ' class='fas fa-user-plus' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='Revisar' ></span> </a>
              </td>";
        echo "</tr>";
